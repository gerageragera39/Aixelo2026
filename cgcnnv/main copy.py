...
UPLOAD_DIR = r"C:\Users\bedhi\Desktop\MOF_Dashboard\uploads"
PB4_EXE = r"C:\Users\bedhi\Desktop\MOF_Dashboard\poreblazer.exe"
DEFAULTS_DAT = os.path.join(os.path.dirname(PB4_EXE), "defaults.dat")
UFF_ATOMS = os.path.join(os.path.dirname(PB4_EXE), "UFF.atoms")
...
CGCNN_DIR = r"C:\Users\bedhi\Desktop\MOF_Dashboard\CGCNN"
...
async def run_prediction():
    def run_and_stream():
        process = subprocess.Popen(
            ["python", "predict.py"],
            cwd="C:/Users/bedhi/Desktop/MOF_Dashboard/CGCNN",
...
async def get_predictions():
    #file_path = "C:/Users/bedhi/Desktop/MOF_Dashboard/CGCNN/results/predictions.csv"
    file_path = "C:/Users/bedhi/Desktop/MOF_Dashboard/output.csv"
    data = []
...
async def predict_new_cif(file: UploadFile = File(...), actual: float = None):
    try:
        ...
        predictions_file = "C:/Users/bedhi/Desktop/MOF_Dashboard/CGCNN/results/predictions.csv"
...
MODEL_PATH = r"C:\Users\bedhi\Desktop\MOF_Dashboard\CGCNN\model_best.pth.tar"
CGCNN_DIR = r"C:\Users\bedhi\Desktop\MOF_Dashboard\CGCNN"
