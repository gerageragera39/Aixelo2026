...
STATIC_DIR = r"F:\Aixelo\Docker_Networks\cgcnnv\static"
...
CGCNN_DIR = r"F:\Aixelo\Docker_Networks\cgcnnv\dataset"
...
async def get_predictions():
    file_path = r"F:\Aixelo\Docker_Networks\cgcnnv\out\output.csv"
    data = []
...
async def predict_new_cif(file: UploadFile = File(...), actual: float = None):
    try:
        ...
        predictions_file = r"F:\Aixelo\Docker_Networks\cgcnnv\out\predictions.csv"
...
MODEL_PATH = r"F:\Aixelo\Docker_Networks\cgcnnv\models\model_best.pth.tar"
CGCNN_DIR = r"F:\Aixelo\Docker_Networks\cgcnnv\dataset"
