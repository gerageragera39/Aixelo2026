...
from config import EXTERNAL_DATA_DIR, MODEL_DIR, RESULTS_DIR
...
# args.data_options = [EXTERNAL_DATA_DIR]
...
def main():
    ...
    validate(train_loader, model, criterion, normalizer, test=True,
             csv_name=os.path.join(RESULTS_DIR, 'train_results.csv'))
    print('---------Evaluate Best Model on Val Set---------------')
    validate(val_loader, model, criterion, normalizer, test=True,
             csv_name=os.path.join(RESULTS_DIR, 'val_results.csv'))
    print('---------Evaluate Best Model on Test Set---------------')
    validate(test_loader, model, criterion, normalizer, test=True,
             csv_name=os.path.join(RESULTS_DIR, 'predictions.csv'))
    train_loss_path = os.path.join(RESULTS_DIR, 'train_loss.csv')
...
def save_checkpoint(state, is_best, filename=os.path.join(MODEL_DIR, 'checkpoint.pth.tar')):
