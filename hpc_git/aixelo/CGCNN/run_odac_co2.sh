#!/bin/bash -l
#SBATCH --job-name=cgcnn_odac_co2
#SBATCH --output=/home/vault/b192aa/b192aa41/projects/cgcnn_odac_co2/logs/%x_%j.out
#SBATCH --error=/home/vault/b192aa/b192aa41/projects/cgcnn_odac_co2/logs/%x_%j.err
