#!/bin/bash -l
#SBATCH --job-name=mgt_qmof
#SBATCH --output=/home/vault/b192aa/b192aa41/projects/mgt_qmof/logs/%x_%j.out
#SBATCH --error=/home/vault/b192aa/b192aa41/projects/mgt_qmof/logs/%x_%j.err
...
DATASET_ARCHIVE="/home/vault/b192aa/b192aa41/datasets/qmof_cif.tar"
