...
class CIFData(Dataset):
    ...
    def __init__(self, root_dir, max_num_nbr=12, radius=8, dmin=0, step=0.2,
                 disable_save_torch=False, random_seed=42, target_column=None):
        ...
        assert target_column is not None, 'target_column must be specified!'
        assert target_column in header, f'target_column {target_column} not found in header: {header}'
        self.target_idx = header.index(target_column)
        ...
        self.torch_data_path = os.path.join(self.root_dir, 'pkl_data')
    ...
    def __getitem__(self, idx):
        ...
        target = self.id_prop_data[idx][self.target_idx]
        ...
        if os.path.exists(os.path.join(self.torch_data_path, cif_id+'.pkl')):
            ...
            crystal = Structure.from_file(os.path.join(self.root_dir + '/raw/',
                                                       cif_id+'.cif'))
