...
parser.add_argument('modelpath', nargs='?', default=None,
                    help="Path to the trained model.")
parser.add_argument('cifpath', nargs='?', default=None,
...
if args.modelpath is None:
    ...
    args.modelpath = os.path.join(MODEL_DIR, "model_best.pth.tar")
if args.cifpath is None:
    args.cifpath = args.data_dir
...
def validate(val_loader, model, criterion, normalizer, test=False,
    ...
    if test:
        star_label = '**'
        import csv
        with open(os.path.join(args.results_dir, csv_name), 'w') as f:
            writer = csv.writer(f)
