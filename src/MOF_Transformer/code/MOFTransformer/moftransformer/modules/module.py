...
class Module(LightningModule):
    def __init__(self, config):
        ...
        # Test predictions storage
        self.test_logits = []
        self.test_labels = []
        self.test_cifid = []
        self.write_log = True
        
        # Validation predictions storage for R² calculation
        self.val_logits = []
        self.val_labels = []
    ...
    def on_validation_start(self):
        module_utils.set_task(self)
        self.write_log = True
        # Reset validation storage at the start of validation
        self.val_logits = []
        self.val_labels = []
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # Collect predictions and labels for R² calculation
        if "regression_logits" in output.keys():
            self.val_logits.extend(output["regression_logits"].cpu().flatten().tolist())
            self.val_labels.extend(output["regression_labels"].cpu().flatten().tolist())
